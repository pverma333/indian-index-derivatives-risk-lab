...
**Path:** `tests/test_outputs/trade_calendar.parquet`
...
**Path:** `tests/test_outputs/trade_calendar.csv`
...
---
### File: mock_derivatives.csv
**Path:** `tests/test_outputs/mock_derivatives.csv`
